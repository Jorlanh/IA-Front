  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      sender: "lia",
      text: "Olá! Eu sou Helena, uma inteligência artificial especialista em avaliação psicopedagógica.\n\Eu atuo com base em regras de avaliação psicopedagógica, levando em consideração indícios de dislexia, dificuldade com leitura, interpretação de texto, escrita, raciocínio lógico e matemática básica. Em que posso te ajudar hoje?",
    },
  ]);
        ...
        >
          ...
          >
            <div className="flex items-center gap-4">
              <img
                src="https://i.imgur.com/2b7a0sQ.png"
                alt="Avatar da LIA, uma assistente psicopedagógica com aparência amigável e profissional"
                className="w-11 h-11 rounded-full border-2 border-white flex-shrink-0"
                loading="lazy"
              />
              ...
              >
                ...
                <div
                  className={
                    ...
                    (sender === "lia" ? "bg-gray-200 text-gray-800" : "bg-blue-200 text-gray-900")
                  }
                >
                  {text}
                </div>
